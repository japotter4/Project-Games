...
namespace FireTokenTestRun
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            myPaddle.Load(Content.Load<Texture2D>("Bottom Paddle"));
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            myBall.Update();
            myBall.Update(myGrid);
            myBall.Update(myPaddle.bounds);

            myPaddle.Update(this);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            myGrid.Draw(spriteBatch, Content.Load<Texture2D>("Brick"));
            myBall.Draw(spriteBatch);
            myPaddle.Draw(spriteBatch);
            myCursor.Draw(spriteBatch);
            myFireBar.Draw(spriteBatch);

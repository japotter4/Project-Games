...
namespace WindowsGame1
{
    public class Ball
    {
        ...
        public void Update()
        {
            if (ball.Y <= 0 || ball.Y + ball.Height >= game1.GraphicsDevice.Viewport.Bounds.Height)
            {
                ballVelocity.Y *= -1;
            }
        }
        ...
        {
            if (ball.Intersects(box) && ball.X < game1.GraphicsDevice.Viewport.Bounds.Width / 2) // player 1, left
            {
            ...
            else if (ball.X + ball.Width > game1.GraphicsDevice.Viewport.Bounds.Width)
            {
                redScore++;
                reset();
            }
